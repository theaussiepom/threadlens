#!/usr/bin/env python3
"""Generate ThreadLens Core UI favicon PNG/ICO assets from the SVG design spec."""
...
BG_TOP = (0x10, 0x2A, 0x43)
BG_BOTTOM = (0x0A, 0x19, 0x29)
MESH_STROKE = (0x2D, 0xD4, 0xBF, 140)
MESH_NODE = (0x5E, 0xEA, 0xD4)
LENS_STROKE = (0x7D, 0xD3, 0xFC)
HANDLE = (0x7D, 0xD3, 0xFC)
...
def main() -> None:
    ...
    print(f"Wrote UI icons under {PUBLIC}")
