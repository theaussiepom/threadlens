"""Ensure dashboard health semantics stay aligned with Core health output."""

from __future__ import annotations

from threadlens.server.dashboard import build_dashboard_payload, compute_health_summary
