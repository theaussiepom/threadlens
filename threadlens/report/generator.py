        ...
        for node in matter_nodes:
            ...
            entries.append(
                ReportMatterNodeEntry(
                    ...
                    last_probe_label=node.last_probe_label,
                    last_successful_probe_kind=node.last_successful_probe_kind,
                    last_successful_probe_path=node.last_successful_probe_path,
